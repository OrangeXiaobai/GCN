...
def Print2D(num_frame, point, arms, rightHand, leftHand, legs, body, output_dir='output_2d'):
    # 创建输出目录
    import os
    ...
    # 保存为PNG文件
    plt.savefig(f'{output_dir}/frame_A066.png', dpi=800)
    plt.close(fig)  # 显式关闭图形对象


def Print3D(num_frame, point, arms, rightHand, leftHand, legs, body, output_dir='output_3d'):
    # 创建输出目录
    import os
    os.makedirs(output_dir, exist_ok=True)
...
if __name__ == '__main__':
    ...
    data_path = './ntu120Data/S018C001P008R001A066.skeleton'
